    ...
    <div className={styles.page}>
      ...
      <Stack gap="x11">
        ...
        <div>
          ...
          <Text myHtml="div" myStyle="h2">Text: myHtml=div; myStyle=h2</Text>
          <Text myHtml="h1" myStyle="h3">Text: myHtml=h1; myStyle=h3</Text>
          <Text myHtml="h3">Text: myHtml=h3</Text>
          <Text>Random: <blockquote>Use text-wrap: balance; on headings and subheadings. And use text-wrap: pretty; on paragraphs of text to get rid of orphans on the last line.</blockquote>  Do you agree?  </Text>
        </div>
      </Stack>
